...
export function AboutSection({ heading, body, ctaLabel, images: sanityImages }: AboutSectionProps) {
  const images = FALLBACK_IMAGES.map((fallback, i) => sanityImages?.[i] ?? fallback)
